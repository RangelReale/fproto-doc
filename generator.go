...
func NewGenerator(dep *fdep.Dep) *Generator {
	return &Generator{
		dep: dep,
	}
}
...
func (g *Generator) GetEnumList(filter *GetFilter) []*fdep.DepType {
...
func (g *Generator) GetMessageList(filter *GetFilter) []*fdep.DepType {
	return g.genList(filter, func(pfile *fproto.ProtoFile) []fproto.FProtoElement {
...
func (g *Generator) GetServiceList(filter *GetFilter) []*fdep.DepType {
	return g.genList(filter, func(pfile *fproto.ProtoFile) []fproto.FProtoElement {
...
func (g *Generator) SortedFieldList(fields []fproto.FieldElementTag) []fproto.FieldElementTag {
...
func (g *Generator) SortedByTagFieldList(fields []fproto.FieldElementTag) []fproto.FieldElementTag {
	var ret []fproto.FieldElementTag
...
func (g *Generator) SortedRPCList(rpcs []*fproto.RPCElement) []*fproto.RPCElement {
...
func (g *Generator) SortedFileList(filterDepType FilterDepType) []string {
	var skeys []string
...
func (g *Generator) SortedPackageList(filterDepType FilterDepType) []string {
	var skeys []string
...
func (g *Generator) genList(filter *GetFilter, pffunc func(pfile *fproto.ProtoFile) []fproto.FProtoElement) []*fdep.DepType {
...
func (g *Generator) sortDepType(m map[string]*fdep.DepType) []*fdep.DepType {
	var skeys []string
	for k, _ := range m {
		skeys = append(skeys, k)
	}
...
func (g *Generator) sortTypeValue(sortType SortType, dp *fdep.DepType) string {
	switch sortType {
	case ST_ALIAS_NAME:
